...
CREATE TABLE `webtoon_base_info` (
	...
	`author`	varchar(10)	NULL COMMENT '작가명',
	`day`	varchar(10)	NULL COMMENT '웹툰의 출시 요일 , 요일이 복수개인 경우가 있으므로 array를 string으로 변환해서 저장',
	`thumbnail`	varchar(100) NULL COMMENT '웹툰 썸네일 링크',
