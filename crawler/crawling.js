...
const crawlingAllChapter = async () => {
  ...
  data = crawlingTuesdayChapter;
  chapters = chapters.concat(data);
  data = crawlingWednesdayChapter;
  chapters = chapters.concat(data);
  data = crawlingThursdayChapter;
  chapters = chapters.concat(data);
  data = crawlingFridayChapter;
  chapters = chapters.concat(data);
  data = crawlingSaturdayChapter;
  chapters = chapters.concat(data);
  data = crawlingSundayChapter;
  chapters = chapters.concat(data);
  return chapters;
};
